...
4. Enable and start the RKE2 Server Service [On Master Node]
   `sudo systemctl enable rke2-server.service && sudo systemctl start rke2-server.service` ![image-20230330185336958](./images/image-20230330185336958.png) 
...
12. Create Persistent Volume Claims
